                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="/res/site/img/products/<?php echo htmlspecialchars( $value1["desimage"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></a>
                                        </td>
