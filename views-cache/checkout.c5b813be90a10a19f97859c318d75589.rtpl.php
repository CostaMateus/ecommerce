								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_address_2_field" class="form-row form-row-wide address-field">
											<label class="" for="billing_district">Complemento (opcional) </label>
											<input type="text" value="<?php echo htmlspecialchars( $address["descomplement"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="Ex: apto 125A" id="billing_address_2" name="descomplement" class="input-text ">
                                        </p>
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first " data-o_class="form-row form-row-first ">
												<input type="radio" id="payment-pagseguro" style="float:left; margin: 30px 15px;" name="payment-method" placeholder="" value="1">
												<label class="" for="payment-pagseguro"><img style="height: 64px;" src="/res/site/img/payment/logo-pagseguro.png" ></label>
											</p>
											<p id="billing_state_field" class="form-row form-row-first " data-o_class="form-row form-row-first ">
												<input type="radio" id="payment-paypal" style="float:left; margin: 30px 15px;" name="payment-method" placeholder="" value="2" checked="checked">
												<label class="" for="payment-paypal"><img style="height: 64px;" src="/res/site/img/payment/logo-paypal.png" ></label>
											</p>
											<div id="payment">
